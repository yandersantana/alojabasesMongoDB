...
export class CuentaPorPagarComponent implements OnInit {
  ...
  listaCuentasActivas: CuentaPorPagar [] = []
  listaCuentasPendientes: CuentaPorPagar [] = []
  listaCuentasAnualadas: CuentaPorPagar [] = []
  ...
  traerListaCuentas(){
    ...
    this._cuentasporPagarService.getCuentasPorPagar().subscribe(res => {
  ...
  eliminarComp(e){
    Swal.fire({
      ...
      if (result.value) {
        this.mostrarLoading = true;
        this._cuentasporPagarService.updateEstadoCuenta(e,"Anulado").subscribe(
          res => { 
            this.mostrarLoading = false; 
  ...
  rechazarEliminacionComp(e){
    Swal.fire({
      ...
      if (result.value) {
        this.mostrarLoading = true;
        this._cuentasporPagarService.updateEstadoCuenta(e,"Activa").subscribe(
          res => { 
            this.mostrarLoading = false; 
  ...
  anularCuenta(e:any){ 
    Swal.fire({
      ...
      if (result.value) {
        this._cuentasporPagarService.updateEstadoCuenta( e ,"Pendiente").subscribe( res => {
          Swal.fire({
            title: 'Correcto',
